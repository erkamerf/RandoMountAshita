...
In-game, you can type `/addon load RandoMountAshita` to get it up and running. We recommend adding this command to a script in the scripts folder. We recommend **against** using `Default.txt` as it may fail to initialize the  randomizer.
